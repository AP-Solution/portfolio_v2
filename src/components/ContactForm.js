...
const ContactForm = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Ваш код для відправки даних на сервер або обробки їх тут
    console.log('Відправлено:', formData);
  };

  return (
    <>
      <section className="max-w-4xl p-6 mx-auto bg-indigo-600 rounded-md shadow-md dark:bg-gray-800 mt-24">
        <h1 className="text-xl font-bold text-white capitalize dark:text-white">Account settings</h1>
        <form>
          <div className="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
            <div>
              <label className="text-white dark:text-gray-200" for="username">Ваше ім'я</label>
            ...
            <div>
              <label className="text-white dark:text-gray-200" for="emailAddress">Електронна пошта</label>
            ...
            <div>
              <label className="text-white dark:text-gray-200" for="password">Пароль</label>
            ...
            <div>
              <label className="text-white dark:text-gray-200" for="passwordConfirmation">Підтвердіть пароль</label>
            ...
            <div>
              <label className="text-white dark:text-gray-200" for="passwordConfirmation">Колір</label>
            ...
            <div>
              <label className="text-white dark:text-gray-200" for="passwordConfirmation">Країна</label>
              <select className="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                ...
                <option>Фінляндія</option>
                <option>Естонія</option>
                <option>Ірландія</option>
                <option>Швеція</option>
              </select>
            </div>
            <div>
